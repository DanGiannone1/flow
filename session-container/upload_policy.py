"""Session-container-local upload validation rules.

Kept in the session-container build context so the Azure session image remains
self-contained even when built from `session-container/`.
"""
