...
| Var | Purpose |
|---|---|
| `AZURE_ENDPOINT` | Azure OpenAI endpoint (e.g. `https://taxagent-ai.openai.azure.com/openai`) |
...
```bash
API_URL=https://taxagent-app.example-env.eastus.azurecontainerapps.io \
APP_URL=https://taxagent-frontend.example-env.eastus.azurecontainerapps.io \
npx playwright test
```
